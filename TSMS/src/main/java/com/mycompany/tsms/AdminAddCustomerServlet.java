...
public class AdminAddCustomerServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "INSERT INTO customer (msisdn, username, birthday, password, job, email, address, twillio_sid, twillio_token) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            // Return an HTML response with a modal box
